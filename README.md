...
For the remote repository, make a github repository named Excel with Python, then do;

```bash
git remote add origin git@github.com:kc-chaudhari/Excel with Python.git
git branch -M main
...
Here's the folder structure that gets created by `cookiecutter-datascience-simple`:
	...
	├── Excel with Python	<- Your notebooks and scripts will live in the main project folder
